...
@AllArgsConstructor
@NoArgsConstructor
public class CsvCfpInfoData implements Serializable {
  ...
  // 構成品レベル
  @JsonProperty("partsStructureLevel")
  ...
  // 材料規格
  @JsonProperty("materialStandard")
  private String materialStandard;
  // 材料分類
  @JsonProperty("materialCategory")
  private String materialCategory;
  // LCA材料コード
  @JsonProperty("lcaMaterialCd")
  private String lcaMaterialCd;
  // 注釈
  @JsonProperty("notes")
  private String notes;
  // 部品調達コード
  @JsonProperty("partsProcurementCd")
  private String partsProcurementCd;
  // 材料調達コード
  @JsonProperty("materiaProcurementCd")
  ...
  // 素材生産国コード
  @JsonProperty("mProductionCountryName")
  private String mProductionCountryName;
  // 素材リサイクル分類PIR
  ...
  // 加工生産国コード
  @JsonProperty("pProductionCountryName")
  private String pProductionCountryName;
  // 加工製造区分
  @JsonProperty("pManufacturingDivision")
  private String pManufacturingDivision;
  // 加工1コード
  @JsonProperty("p1ProcessingStepName")
  private String p1ProcessingStepName;
  // 加工2コード
  @JsonProperty("p2ProcessingStepName")
  private String p2ProcessingStepName;
  // 加工3コード
  @JsonProperty("p3ProcessingStepName")
  private String p3ProcessingStepName;
  // 加工4コード
  @JsonProperty("p4ProcessingStepName")
  private String p4ProcessingStepName;
  // 加工消費電力エネルギー比率
